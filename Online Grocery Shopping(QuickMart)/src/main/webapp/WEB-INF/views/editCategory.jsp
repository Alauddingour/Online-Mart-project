...
<input class="form-control" type="text" name="name" maxlength="30" id="name" value="${category.name}" required="required" autofocus="autofocus" placeholder="Enter Category Name">
...
<div class="form-group row">
<textarea class="form-control" name="description" cols="5" id="description" rows="2" maxlength="200" style="width: 500px;resize: none;" placeholder="Enter Description" required="required">${category.description}</textarea>
