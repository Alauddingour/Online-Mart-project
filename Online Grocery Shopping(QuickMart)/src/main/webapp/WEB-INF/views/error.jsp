...
<header>
        <nav class="navbar-expand-md navbar-light fixed-top" id="navbar" >
          ...
          <div class="error-image" style="margin-left: 350px;">
          <img src="${pageContext.request.contextPath}/images/errorPage.png">
          </div>
          <div style="margin-left: 590px">
          <a class="btn btn-primary" href="<spring:url value='/Home'/>">Go back to Home</a>
          </div>
          </div>
</body>
</html>