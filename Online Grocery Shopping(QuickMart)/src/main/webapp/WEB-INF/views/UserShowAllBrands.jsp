...
<header>
        <nav class="navbar-expand-md navbar-light fixed-top" id="navbar" >
          ...
          <h2 style="margin-left: 600px">Shop By Brand</h2>
          <div class="row" style="width: 250px;margin-left: 600px;margin-top: 40px">
          <c:forEach var="brands" items="${brandNames}">
          <div class="row" style="background-color: ">
            <a href="<spring:url value='/UserShowProductByBrand'/>?id=${brands.id}"><label style="font-size: large;font-weight: bolder;margin-left: 6px">${brands.name}</label></a>
          </div>
          <hr style="width: 210px">
          </c:forEach>
          <div>
          <c:if test="${brandNames.size() > 0 }">
        <div class="panel-footer" style="margin-left: 30%;margin-top: 50px">
            <ul class="pagination">
                <c:forEach begin="0" end="${totalPages-1}" var="page">
                    <li class="page-item" style="margin-left: 4px">
                        <a href="UserShowAllBrands?pageNum=${page+1}" class="page-link">${page+1}</a>
                    </li>
                </c:forEach>
                </ul>
                </div>
