...
<header>
        <nav class="navbar-expand-md navbar-light fixed-top" id="navbar" >
          ...
          <div class="container">
    <div class="container px-4 py-4" style="margin-top: 4%;">
        ...
        <div class="row">
          ...
          <div class="col  col-md-auto" style="min-width: 200px;"><div style="width: 200px;height: 200px;border: 1px solid black;border-radius: 10px;">
              <a href="<spring:url value='/UserShowProductByCategory'/>?id=${category.id}"><img src="${pageContext.request.contextPath}/images/${category.image}" style="width: 180px;height: 180px;margin-left: 8.5px;margin-top: 8px;"></a>
          </div>
          <div>
    ...
    <c:if test="${data.size() > 0 }">
        <div class="panel-footer" style="margin-left: 30%;margin-top: 5px">
            <ul class="pagination">
                <c:forEach begin="0" end="${totalPages-1}" var="page">
                    <li class="page-item" style="margin-left: 4px">
                        <a href="UserSeeAllCategories?pageNum=${page+1}" class="page-link">${page+1}</a>
                    </li>
                </c:forEach>
            </ul>
        </div>
