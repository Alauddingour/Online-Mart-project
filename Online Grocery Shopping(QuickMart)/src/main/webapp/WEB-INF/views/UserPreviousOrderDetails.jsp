...
<c:if test= "${empty setDelivered}">
				 <span style="font-size: large;margin-left: 20px">No Previous Orders</span>
				 <h3>
<a class="btn btn-primary" href="<spring:url value='/Home'/>" style="margin-left: 20px">Continue Shopping</a>
</h3>
				 </c:if>
				 </div>
				 <div>
<c:if test= "${!empty setDelivered}">
<c:forEach var="item" items="${setDelivered}">
<div>
