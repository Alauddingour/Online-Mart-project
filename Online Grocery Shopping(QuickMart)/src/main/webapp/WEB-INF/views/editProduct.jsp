...
function addTextBoxDataCategory(e){
	...
	var element2 = document.getElementById('description').value;
	var element3 = document.getElementById('price').value;
	var element4 = document.getElementById('brand').value;
	if(element1!="" && element2!="" && element3!="" && element4!=""){
    e.href = "<spring:url value='/addCategory'/>" + "?name=" + document.getElementById('name').value+ "&description=" + document.getElementById('description').value+ "&price=" + document.getElementById('price').value+ "&brand="+document.getElementById('browser').value;
	}
	else
		{
...
<input type="text" class="form-control" name="name" id="name"  maxlength="50" value="${product.name}" required="required" autofocus="autofocus" placeholder="Enter Name">
 <span id="errorName" class="error"></span>
 </div>
 <div class="form-group row">
<textarea name="description" class="form-control" cols="5" id="description" rows="2" maxlength="200" style="width: 500px;resize: none;" placeholder="Enter Description" required="required">${product.description}</textarea>
 <span id="errorDescription" class="error"></span>
 </div>
 <div class="form-group row">
<input type="text" name="price" class="form-control" id="price" required value="${product.price}" placeholder="Enter Price">
...
<div class="form-group row">
<input list="brand" name="brand" class="form-control" id="browserB" value="${product.brands.name}" required placeholder="Choose Brand Name">
 <datalist id="brand">
...
<div class="form-group row">
<input list="category" name="category" class="form-control" value="${product.category.name}" id="browserCategory" placeholder="Choose Category Name" required>
