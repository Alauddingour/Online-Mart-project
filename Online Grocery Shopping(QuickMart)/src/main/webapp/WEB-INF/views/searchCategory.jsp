...
<header>
        <nav class="navbar-expand-md navbar-light fixed-top" id="navbar" >
          ...
          <h4>Results of search category</h4>
          <table class="table table-hover table-bordered" style="border: 1px solid black;margin-top: 20px">
				...
				<tbody>
						<tr>
							<td>${searchCategory.id}</td>
							<td style="max-width: 150px; 
                         word-wrap: break-word;overflow: hidden;
      text-overflow: ellipsis;">${searchCategory.name}</td>
							<td style="max-width: 150px; 
                         word-wrap: break-word;overflow: hidden;
      text-overflow: ellipsis;">${searchCategory.description}</td>
							<td>
          <img src="${pageContext.request.contextPath}/images/${searchCategory.image}" width="70" height="90" class="img img-responsiive" /></td>
						    <td style="padding-left: 10px"><a class="btn btn-secondary" href = "<spring:url value='/editCategory'/>?id=${searchCategory.id}">Edit</a></td>
						    <td style="padding-left: 10px"><a class="btn btn-secondary" style="background-color: red" href = "<spring:url value='/deleteCategory'/>?id=${searchCategory.id}">Delete</a></td>
						</tr>
				</tbody>
			</table>
			</div>
