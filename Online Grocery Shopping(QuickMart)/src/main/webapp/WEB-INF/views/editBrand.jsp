...
<input class="form-control" type="text" name="name" id="name" value="${brand.name}"  maxlength="30" required="required" autofocus="autofocus" placeholder="Enter Brand Name">
<span id="errorName" class="error"></span>
</div>
<hr>
<div style="margin-left: 50px">
<input class="btn btn-secondary" type="submit" id="submitButton" value="Add Brand" style="width: 400px" >
</div>
</form>
</div>
</body>
