     ...
     <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
      ...
      $(function()
    	  ...
    	  $("#searchButton").click(function()
    			  {
    		     $('#pending').find('option').each(function() {
      		               if($(this).val()==$("#browser").val())
      		            	   {
      		            	   window.location="<spring:url value='/searchOrder'/>?id="+$(this).val();
      		            	   }
      		          });
    			  })
...
<input  list="pending" name="pending" id="browser" placeholder="Search Orders By Id..." style="width: 400px;border-radius: 8px" list="pending"> 
 <datalist id="pending">
 <select id="pending">
    <c:forEach items="${allPendingOrders}" var="order">
        <option data-value="${order.id}" value="${order.id}">${order.id}</option>
    </c:forEach>
</select>
  </datalist>
